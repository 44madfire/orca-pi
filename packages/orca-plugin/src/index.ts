...
export {
  ...
  type DiagnosticsCliEntry,
  type DiagnosticsHostHealth,
  type DiagnosticsOverviewInput,
  type DiagnosticsOverviewRow,
  type DiagnosticsRuntimeHealth,
  type DiagnosticsWorktreeHealth,
  type DraftIssue,
  type GithubActorSummary,
  type GithubDoctorItem,
  type GithubMappedProfile,
